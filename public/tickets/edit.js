    ...
    <div class="container-sm mt-4">
        ...
        <form action="/tickets/${ticket.id}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="range" class="form-range" id="score" value=${ticket.score} min="0" max="1" step="0.1" />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa-solid fa-cloud-arrow-up"></i> Submit</button>
        </form>
    </div>
    `;
};
